...
\restrict 3mwnW6VT0NcGKFe2yN3dkX5WzCamnZrEalGTYjKqRbQglC24FkYxuwtbYR4kzcE
...
ALTER TABLE ONLY public.transaction_items DROP CONSTRAINT transaction_items_payment_method_id_fkey;
ALTER TABLE ONLY public.transaction_items DROP CONSTRAINT transaction_items_group_id_fkey;
ALTER TABLE ONLY public.transaction_items DROP CONSTRAINT transaction_items_category_id_fkey;
ALTER TABLE ONLY public.transaction_groups DROP CONSTRAINT transaction_groups_profile_id_fkey;
ALTER TABLE ONLY public.transaction_groups DROP CONSTRAINT transaction_groups_branch_id_fkey;
ALTER TABLE ONLY public.transaction_attachments DROP CONSTRAINT transaction_attachments_group_id_fkey;
ALTER TABLE ONLY public.stock_mutations DROP CONSTRAINT stock_mutations_to_branch_id_fkey;
ALTER TABLE ONLY public.stock_mutations DROP CONSTRAINT stock_mutations_product_id_fkey;
ALTER TABLE ONLY public.stock_mutations DROP CONSTRAINT stock_mutations_from_branch_id_fkey;
...
ALTER TABLE ONLY public.profiles DROP CONSTRAINT profiles_role_id_fkey;
ALTER TABLE ONLY public.profiles DROP CONSTRAINT profiles_branch_id_fkey;
ALTER TABLE ONLY public.products DROP CONSTRAINT products_profile_id_fkey;
ALTER TABLE ONLY public.products DROP CONSTRAINT products_category_id_fkey;
ALTER TABLE ONLY public.products DROP CONSTRAINT products_branch_id_fkey;
ALTER TABLE ONLY public.product_stocks DROP CONSTRAINT product_stocks_product_id_fkey;
ALTER TABLE ONLY public.product_stocks DROP CONSTRAINT product_stocks_branch_id_fkey;
ALTER TABLE ONLY public.product_categories DROP CONSTRAINT product_categories_profile_id_fkey;
ALTER TABLE ONLY public.payment_methods DROP CONSTRAINT payment_methods_profile_id_fkey;
ALTER TABLE ONLY public.orders DROP CONSTRAINT orders_profile_id_fkey;
...
ALTER TABLE ONLY public.categories DROP CONSTRAINT categories_profile_id_fkey;
ALTER TABLE ONLY public.branches DROP CONSTRAINT branches_tenant_id_fkey;
DROP INDEX public.transaction_groups_reference_number_key;
DROP INDEX public.roles_name_key;
DROP INDEX public.profiles_username_key;
DROP INDEX public.profiles_email_key;
DROP INDEX public.product_stocks_product_id_branch_id_key;
DROP INDEX public.product_categories_profile_id_name_key;
DROP INDEX public.permissions_name_key;
DROP INDEX public.payment_methods_profile_id_name_key;
DROP INDEX public.orders_reference_number_key;
DROP INDEX public.categories_profile_id_name_type_key;
ALTER TABLE ONLY public.transaction_items DROP CONSTRAINT transaction_items_pkey;
ALTER TABLE ONLY public.transaction_groups DROP CONSTRAINT transaction_groups_pkey;
ALTER TABLE ONLY public.transaction_attachments DROP CONSTRAINT transaction_attachments_pkey;
ALTER TABLE ONLY public.stock_mutations DROP CONSTRAINT stock_mutations_pkey;
ALTER TABLE ONLY public.roles DROP CONSTRAINT roles_pkey;
ALTER TABLE ONLY public.role_permissions DROP CONSTRAINT role_permissions_pkey;
ALTER TABLE ONLY public.profiles DROP CONSTRAINT profiles_pkey;
ALTER TABLE ONLY public.products DROP CONSTRAINT products_pkey;
ALTER TABLE ONLY public.product_stocks DROP CONSTRAINT product_stocks_pkey;
...
DROP TABLE public.transaction_groups;
...
\unrestrict 3mwnW6VT0NcGKFe2yN3dkX5WzCamnZrEalGTYjKqRbQglC24FkYxuwtbYR4kzcE
